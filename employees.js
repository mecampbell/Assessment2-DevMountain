...
const empOne = new Employee('Jessica Day', 'weekday mornings, weekday afternoons');
...
const empTwo = {...empOne, name: 'Nick Miller'};
console.log(empTwo);
...
const manager = new Manager('Winston Bishop', 'weekday mornings, weekday afternoons', ['Cece', ' Schmidt']);
